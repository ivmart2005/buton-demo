...
export function Canvas() {
  ...
  // ресайз всего букета комбинацией CTRL + колёсико мыши
  useEffect(() => {
    const handleWheel = (event: WheelEvent) => {
      if (event.ctrlKey || event.metaKey) {
        ...
        updateAllFlowers((flower) => {
          const delta_X = flower.x - centerX;
          const delta_Y = flower.y - centerY;
          return {
            x: centerX + delta_X * factor,
            y: centerY + delta_Y * factor,
